...
class _MapViewState extends State<MapView> {
  BitmapDescriptor pinLocationIcon, nationpark, art, eco, history, hot, jogging, museum, pin, fun, scenery, temple, flag, farm;

  CameraPosition _initialLocation = CameraPosition(target: LatLng(23.759111560110114, 120.99005815147324), zoom : 8);
  ...
  void setCustomMapPin() async {
    ...
    temple = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5),
        'Images/temple.png');
    farm = await BitmapDescriptor.fromAssetImage(
        ImageConfiguration(devicePixelRatio: 2.5),
        'Images/farming.png');
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: [
                        ...
                        markeroption("休閒農業",stringfarm,stringfarm_la,stringfarm_lo, farm, 10),

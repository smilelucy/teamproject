...
class _WeatherchineseState extends State<Weatherchinese> {
  ...
  var maxfeellike;
  var humidity;
  var current = DateTime.now().add(new Duration(hours: 0)).hour;
  // var current = 20;
  ...
  // static var df =  DateFormat("h:mma");
  // var dt = df.parse('6:45PM');
  // final String ampm = _timeOfDay.format(context);
  // final timeStr = TimeOfDay.now().format();
  ...
  Future settime() async {
    setState(() {
      if(timemod > 2) {
        ...
        // last2 = last2 + 12;
        if (last2 < 10) {
          datatime = '$formattedDate' + '0'+'$last2' + ":00:00" ;
        } else {
  ...
  changeText() {
    setState(() {
      ...
      print('datatime,$datatime');
      // print('format,$format');
      print('_timeofday,${_timeOfDay.format(context)}');
              ...
              // night~~~~~~~~
                Visibility(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage('Images/night2.png')
                        )
                    ),
                    // color: Color(0xff457B9D),
                    // child: Column(
              ...
              child: Padding(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    //     leading: FaIcon(FontAwesomeIcons.cloudRain),
                    //     title: Text("濕度"),
                    //     trailing: Text(datatime != null ? datatime.toString() + '%' : "Loading"),
                    //   ),
                    // ),
                    // Padding(
                    //   padding: const EdgeInsets.only(left: 4),

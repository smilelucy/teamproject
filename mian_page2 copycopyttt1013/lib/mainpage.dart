                  ...
                  Stack(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          margin: EdgeInsets.only(
                              left: 190, top: 40, right: 0, bottom: 0),
                          // height: 120.0,
                        ),
                        // SizedBox(height: ,),
                        Container(
                          margin: EdgeInsets.only(
                              left: 150, top: 75, right: 0, bottom: 0),
                          child: Row(
                            children: <Widget>[
                              // SizedBox(height: 20,),
                              Text('Nantou Information',style: TextStyle(fontSize: 12),),
                              // SizedBox(height: 20,),
                              Text('Tourism Application',style: TextStyle(fontSize: 12))
                            ],
                          ),
                        )
                      ],
...
//                                side: BorderSide(color: Color(0xff4f748e))),
                            child: RaisedButton(
                              color: Color(0xff71a2c1),// 0xffa8bece
                              onPressed: () {
                                Navigator.pop(context);
                                Navigator.push(
                                    context,
